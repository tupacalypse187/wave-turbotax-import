...
export default function FileUpload() {
  ...
  return (
    <div className="file-upload space-y-6">
      {!isCaptchaVerified && (
        <div className="flex flex-col items-center justify-center p-6 bg-slate-800/50 rounded-xl border border-slate-700/50 backdrop-blur-sm transition-all animate-in fade-in zoom-in-95 duration-300">
          <h3 className="text-lg font-semibold text-white mb-4">Security Check</h3>
          <Turnstile
          ...
          />
          <p className="mt-4 text-slate-400 text-sm">Please verify you are human to continue</p>
        </div>
      )}
